...
<script src="js/mymoment.js"></script>
</head>
<body>
	<div id="container">
		<div id="mainContent">
			...
			<div id="chatArea">
				...
				<br/>
				<div id="allFriend">
				<a href = "moment_list"><input type="button" value="返回"></a>
				<div id = "temp">
...
<%              
		        ...
		        for(int i = 0; i < count; i++) {
			       ...
			       //  System.out.println(moment.getC_id());
			        // System.out.println(moment.getId()+"likeid");
			         		         
%>
                <table border="0" id="content-table" cellpadding="0" cellspacing="0">
                <tr>
                   <td><div><img src="images/4.jpg"></div> &nbsp<%=user.getNickName() %></td>          
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <a href = "like_save?mo_id=<%=moment.getId() %>&mark=1"><input type="button" value="点赞"></a>
                    <a href = "moment_detele?m_id=<%=moment.getId() %>"><input type="button" value="删除"></a>           
                    </td>
                </tr>
                <tr>
      <%
