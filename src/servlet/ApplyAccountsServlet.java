 ...
 */
@WebServlet("/ApplyAccountsServlet")
public class ApplyAccountsServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;

	/**
     * @see HttpServlet#HttpServlet()
     */
	public ApplyAccountsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("apply_account.jsp").forward(request, response);
    }
